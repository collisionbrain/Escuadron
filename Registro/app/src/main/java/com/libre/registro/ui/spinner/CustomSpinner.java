...
public class CustomSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        backgroundSelector = typedArray.getResourceId(R.styleable.customSpinner_backgroundSelector, R.drawable.selector);
        setBackgroundResource(backgroundSelector);
        setBackgroundColor(getResources().getColor(R.color.gray));
        textColor =  typedArray.getColor(R.styleable.customSpinner_textTint, -1);
    ...
    public <T> void attachDataSource(@NonNull List<T> dataset) {
        adapter = new CustomSpinnerAdapter<>(getContext(), dataset, getResources().getColor(R.color.gray), backgroundSelector);
