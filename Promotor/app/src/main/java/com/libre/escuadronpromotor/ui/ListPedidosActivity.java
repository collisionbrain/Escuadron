    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ListPedidosActivity.this,RegisterActivity.class);
        ...
        //newOrders= db.getAllMembers();

        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
        recyclerView.setLayoutManager(mLayoutManager);
        newOrderAdapter = new NewOrderAdapter(this, newOrders);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 500) {
            if (resultCode == RESULT_OK) {
                ...
                //newOrderAdapter = new NewOrderAdapter(this, newMembers);
                recyclerView.setAdapter(newOrderAdapter);
            }
        }
        if (requestCode == 600) {
        ...
        usersRef.child(userGuid).setValue(newMember,new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                if (databaseError == null) {
                    ...
                    //newMembers= db.getAllMembers();
                   // newOrderAdapter = new newOrderAdapter(context, newMembers);
                    recyclerView.setAdapter(newOrderAdapter);
                }
            }
        });
