package com.libre.escuadronpromotor.ui.animations;
...
public class DotProgressBar extends View {
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                setStartColor(
                        a.getInteger(
                                ...
                                ContextCompat.getColor(getContext(), R.color.green_toolbar)
                        )
                );
                setEndColor(
                        a.getInteger(
            ...
            setStartColor(ContextCompat.getColor(getContext(), R.color.green_toolbar));
            setEndColor(ContextCompat.getColor(getContext(), R.color.green_text));
